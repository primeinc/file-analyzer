...
def quick(
    ...
    output_format: str = typer.Option(
        "pretty", "--format", "-f", help="Output format: pretty, json, md"
    ),
    json_output: bool = typer.Option(False, "--json", help="Output in JSON format"),
    markdown_output: bool = typer.Option(
        False, "--md", help="Output in Markdown format"
    ),
    verbose: bool = typer.Option(
        False, "--verbose", "-v", help="Show detailed logging"
    ),
):
...
def main(
    ...
    file_path: str | None = typer.Argument(
        None, help="Path to file to analyze (default: quick analysis)"
    ),
    output_format: str = typer.Option(
        "pretty", "--format", "-f", help="Output format: pretty, json, md"
    ),
    ...
    if verbose:
        logger.debug(
            f"Registered subcommands: {[typer_instance.name for typer_instance in app.registered_typer_instances]}"
        )
