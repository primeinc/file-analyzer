...
def run_test(context: dict[str, Any]) -> dict[str, Any]:
    ...
    if console:
        console.print("[blue]=== Testing FastVLM JSON Output Validation ===[/blue]")
    ...
    # Find test images
    if console:
        console.print("[blue]Finding test images...[/blue]")
    ...
    if console:
        console.print("[blue]1. Testing basic JSON output with primary image...[/blue]")
    ...
    if console:
        console.print("[blue]2. Testing with custom prompt for JSON...[/blue]")
    ...
    if console:
        console.print("[blue]4. Testing batch processing on multiple images...[/blue]")
    ...
    if console:
        console.print("[blue]5. Validating JSON files...[/blue]")
        ...
        if not json_files:
            ...
            for json_file in json_files:
                ...
                try:
                    ...
                    validation_result["error"] = f"Invalid JSON: {e!s}"
                    if console:
                        console.print("  ✗ Invalid JSON (acceptable for testing)")
                except Exception as e:
                    validation_result["error"] = f"Error: {e!s}"
