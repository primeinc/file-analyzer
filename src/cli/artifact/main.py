...
from src.core.artifact_guard import cleanup_artifacts as cleanup_artifact_dirs
from src.core.artifact_guard import setup_artifact_structure as setup_artifact_dir
...
def info(
    ...
    try:
        ...
        console.print("      ├── vision/     - Vision model outputs")
        console.print("      ├── test/       - Test outputs")
        console.print("      ├── benchmark/  - Performance benchmarks")
        console.print("      └── tmp/        - Temporary files (auto-cleaned)")
