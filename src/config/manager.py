...
class ConfigManager:
    ...
    def set(self, key: str, value: Any) -> None:
        ...
        """
        logger.warning(
            f"ConfigManager.set() called for key '{key}' - "
    ...
    def load_config(self, config_path: str = None) -> None:
        ...
        """
        logger.debug(
            f"ConfigManager.load_config() called with path '{config_path}' "
    ...
    def save_config(self, config_path: str = None) -> None:
        ...
        """
        logger.warning(
            f"ConfigManager.save_config() called with path '{config_path}' "
